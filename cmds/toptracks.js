...
module.exports = {
    name: 'Top Tracks',
    aliases: [ 'toptracks', 'top1' ],
    group: 'top scrobbles',
    description: 'Displays your 10 top tracks.',
    async run(client, msg, db) {
        ...
        for (let i = 0; i < top.length; ++i) {
            ...
            let track = top[i];
            pages[pages.length - 1] += `<:banana_milk:1045928025654575194> **${(i+1)}.** **[${track.name}](${track.url})** by **${track.artist.name}** (**${track.playcount}** scrobbles)\n`;
        }
